...
| 04 | Vulnerability Scanning | Scanned an intentionally vulnerable machine using OpenVAS, Nessus Essentials, and Nmap NSE scripts to identify known CVEs, assess severity ratings, and document remediation recommendations | 🔄In Progress | |
